  ...
  return (
    ...
    >
      ...
      >
        <div className="flex flex-col justify-center items-center text-center min-h-[60vh] max-w-[1000px] mx-auto gap-5 p-4 relative">
          ...
          <div className="relative inline-block">
            <h1 className="m-0 pl-4 inline-block text-[40px] sm:text-[50px] md:text-[65px] text-[#211f54] font-bold leading-tight">
      ...
      <div className="flex justify-center items-center   md:bg-transparent">
        <h1 className="hidden text-[62px] sm:text-[64px] md:text-[120px] lg:text-[200px] font-bold text-[#b0babf]">
          WEDDING
        </h1>
      </div>
    </div>
